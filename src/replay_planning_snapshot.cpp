...
int main(int argc,char** argv) {
    try {
        if(argc<2) throw std::runtime_error("usage: replay_planning_snapshot FILE [--expansions N] [--repeat N] [--trajectory]");
        ...
        const auto input=groundgrid::loadPlanningSnapshot(argv[1]);
